// APEX Detailing — данные, иконки, состояние приложения
...
const LOCATIONS = [
  { id: 'studio', name: 'Студия APEX на Дмитровском', sub: '15–20 мин от вашего района', extra: 0 },
...
function seedState() {
  return {
    ...
    cars: [
      ...
      { id: 'car3', brand: 'Lexus', model: 'LS 500', plate: 'Е 500 ЛХ 799', size: 'suv', passport: 92, lastService: 'PPF нанесена 3 февраля 2026' }
    ],
